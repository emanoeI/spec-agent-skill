...
- For schema changes, define the migration order, backup/restore check, data integrity invariant and compatibility window before changing reads or writes.
- Prefer an expand-and-contract migration when old and new application versions may overlap.
